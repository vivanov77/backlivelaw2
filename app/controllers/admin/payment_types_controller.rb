class Admin::PaymentTypesController < Admin::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @payment_type.save
        format.html { redirect_to [:admin, @payment_type], notice: 'Платёжный тип был успешно создан.' }
  ...
  def update
    respond_to do |format|
      if @payment_type.update(payment_type_params)
        format.html { redirect_to [:admin, @payment_type], notice: 'Платёжный тип был успешно обновлён.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_payment_types_url, notice: 'Платёжный тип был успешно удалён.' }
  ...
  private
    ...
    def payment_type_params
      # params.require(:payment_type).permit(:sender_id, :recipient_id, :comment, :cfrozen, :operation, :sum, payable: [:ctype])
