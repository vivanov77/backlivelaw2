class Admin::DocResponsesController < Admin::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @doc_response.save
        format.html { redirect_to [:admin, @doc_response], notice: 'Ответ на запрос документа был успешно создан.' }
  ...
  def update
    respond_to do |format|
      if @doc_response.update(doc_response_params)
        format.html { redirect_to [:admin, @doc_response], notice: 'Ответ на запрос документа был успешно обновлён.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_doc_responses_url, notice: 'Ответ на запрос документа был успешно удалён.' }
